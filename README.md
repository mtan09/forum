...
- **Search + Discover** across posts, articles, #hashtags, sources, and people, with quick-topic entry points and filters for stories, people, and sources
...
- **forumAI**: a guided three-perspective workspace that streams Left / Center / Right readings in a focused lens view, grounded in the app's own article corpus (RAG), with audience framing, starter prompts, conversation memory, and an "Ask forumAI" entry point from article and post pages
